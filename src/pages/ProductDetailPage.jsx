...
const getBookById = (id) => {
  ...
  const booksData = [
    ...
    },
    {
      ...
      owner: "Priya Patel",
      ownerRating: 4.7,
      description: "The ultimate reference guide for 12th standard Computer Science students. Covers all topics in the curriculum with detailed explanations, diagrams, and practice problems. Includes sections on programming in C++, data structures, database management systems, and computer networks.",
      additionalImages: [
        "/OIP (2)_1.jpg",
        "/OIP (2)_2.jpg"
      ]
    },
    {
      ...
      owner: "Aditya Mehta",
      ownerRating: 4.8,
      description: "The complete magical journey of Harry Potter in this 7-book collection by J.K. Rowling. Follow Harry from his first days at Hogwarts School of Witchcraft and Wizardry to his final battle with Lord Voldemort. This collection includes all seven books in the series: Philosopher's Stone, Chamber of Secrets, Prisoner of Azkaban, Goblet of Fire, Order of the Phoenix, Half-Blood Prince, and Deathly Hallows.",
...
const ProductDetailPage = () => {
  ...
  const [offerPrice, setOfferPrice] = useState(Math.floor(book?.price * 0.8) || 0);
  ...
  const handleSubmitOffer = () => {
    ...
    alert(`Offer of ₹${offerPrice} for ${rentalDuration} submitted successfully!`);
    closeOfferModal();
  };
    ...
    <Layout showSidebar={true}>
      <div className="flex-1 p-4 md:p-6 bg-gray-50">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-6">
          <button onClick={() => navigate('/books')} className="flex items-center hover:text-purple-600">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2">
                  {allImages.map((img, index) => (
                    <div 
                      ...
                      <img src={img} alt={`${book.name} ${index + 1}`} className="w-full h-full object-cover" />
                    </div>
                  ))}
                </div>
              )}
            ...
            <div className="w-full lg:w-3/5">
              <div className="flex justify-between items-start">
                <h1 className="text-2xl font-bold text-gray-800 mb-2">{book.name}</h1>
                <div className="flex gap-2">
                  <button 
                    onClick={toggleWishlist}
                    className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      isWishlisted ? 'bg-red-50 text-red-500' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'
                    }`}>
              ...
              <div className="text-2xl font-bold text-purple-600 mb-4">
                ₹{book.price} <span className="text-sm font-normal text-gray-500">per week</span>
              </div>
              
              <div className="bg-purple-50 rounded-lg p-4 mb-6">
                <h3 className="font-medium text-purple-700 mb-2">About this item</h3>
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-lg mb-6">
                ...
                <div>
                  <div className="text-sm font-medium">Rented by {book.owner}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  onClick={() => alert(`Renting ${book.name} for ₹${book.price} per week`)}>
                  Rent Now
          ...
          {showOfferModal && (
            <motion.div
              ...
              <motion.div
                ...
                <div className="p-6">
                  <div className="mb-6">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Your Offer Price (per week)</label>
                    <div className="mb-2">
                    ...
                    <div className="text-center text-xl font-bold text-purple-600">₹{offerPrice}</div>
                  </div>
                  ...
                  <div className="p-4 bg-purple-50 rounded-lg mb-6">
                    ...
                    <div className="flex justify-between pt-2 border-t border-purple-200 mt-2">
                      ...
                      <span className="font-bold text-purple-600">
                        ₹{offerPrice * (rentalDuration === "1 Week" ? 1 : rentalDuration === "2 Weeks" ? 2 : 4)}
                      </span>
                    </div>
                  </div>
